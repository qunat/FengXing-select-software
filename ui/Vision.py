...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "软件名称：FA自动化零件选型软件"))
        self.label_2.setText(_translate("Form", "软件大小：750MB"))
        self.label_9.setText(_translate("Form", "软件版本：V1.0.1"))
        ...
        self.label_6.setText(_translate("Form", "下载链接：www.aliyuncad.com"))
        self.label_7.setText(_translate("Form", "软件用途：快速生成自动化零件的3D数据"))
